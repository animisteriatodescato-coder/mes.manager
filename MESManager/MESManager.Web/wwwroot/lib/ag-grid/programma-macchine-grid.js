    ...
    const columnDefs = [
        {
            ...
            cellRenderer: params => {
                ...
                return `<div class="mes-move-cell">
                    <button class="mes-move-btn move-up-btn" title="Sposta su">▲</button>
                    <button class="mes-move-btn move-down-btn" title="Sposta giù">▼</button>
                </div>`;
            },
        ...
        window.ricettaColumnShared.createColumnDef({
            ...
            gridNamespace: 'programmaMacchineGrid',
